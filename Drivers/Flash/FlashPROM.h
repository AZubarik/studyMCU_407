...
#define STARTADDR ((uint32_t)0x0807FFE0)         // адрес, с которого будет начинаться запись во флеш (с начала 126-ой страницы F103)
#define ENDMEMORY ((uint32_t)0x0807FFF0 + 1024)  // последняя ячейка флеша (F103)
